...
INSERT INTO
    SIMPLEFILE (NAME, ADDRESS)
VALUES
    ('Einstein', '112 Mercer St, Princeton NJ 08540'),
    ('Mozart', 'Domgasse 5, 1010 Vienna Austria'),
    (
        'Shakespeare',
    ...
    ('Tesla', '8 West 40th St, New York NY 10018'),
    (
        'Newton',
    ...
    ('Turing', 'Wilmslow Rd, Manchester M13 9PL UK'),
    ('Jobs', '1 Infinite Loop, Cupertino CA 95014'),
    ('Gates', '1835 73rd Ave NE, Medina WA 98039'),
    ('Musk', '3500 Deer Creek Rd, Palo Alto CA 94304'),
    ('Bezos', '410 Terry Ave N, Seattle WA 98109'),
    ('Zuckerberg', '1 Hacker Way, Menlo Park CA 94025'),
    ('Wozniak', '2066 Crist Dr, Los Altos CA 94024'),
    ('Torvalds', 'Dunthorpe, Portland OR 97219'),
    (
        'Berners-Lee',
        'MIT CSAIL, 32 Vassar St, Cambridge MA 02139'
    ),
    ('Knuth', '450 Serra Mall, Stanford CA 94305'),
    (
        'Dijkstra',
        'Plataanstraat 5, 5671 AL Nuenen Netherlands'
    ),
    ('Hopper', 'Yale University, New Haven CT 06520'),
    (
        'Lovelace',
        '6 St James Square, London SW1Y 4JU UK'
    ),
    ('Babbage', '1 Dorset St, London W1U 4EG UK'),
    ('Boole', 'University College Cork, Cork Ireland'),
    (
        'Mandela',
    ...
    ('King Jr', '501 Auburn Ave NE, Atlanta GA 30312'),
    (
        'Churchill',
    ...
    ('Columbus', 'Calle Colon 1, 41001 Seville Spain'),
    (
        'Magellan',
        'Rua de Sabrosa, 5060-284 Sabrosa Portugal'
    ),
    ('Armstrong', '8001 Gemini Ave, Houston TX 77058'),
    ('Aldrin', '2101 NASA Pkwy, Houston TX 77058'),
    (
        'Gagarin',
        'Star City, Moscow Oblast 141160 Russia'
    ),
    ('Wright', '1127 West Third St, Dayton OH 45402'),
    ('Edison', '2350 Lakeside Ave, Orange NJ 07050'),
    ('Bell', '537 Washington St, Boston MA 02111'),
    ...
    ('Scorsese', '445 Park Ave, New York NY 10022'),
    (
        'Coppola',
    ...
    ('Streep', '888 Seventh Ave, New York NY 10019'),
    (
        'Hanks',
    ...
    ('Beatles', '3 Savile Row, London W1S 3PB UK'),
    (
        'Presley',
        '3734 Elvis Presley Blvd, Memphis TN 38116'
    ),
    ('Jackson', '2300 Jackson St, Gary IN 46407'),
    (
        'Madonna',
    ...
    ('Lennon', '1 W 72nd St, New York NY 10023'),
    ('Marley', '56 Hope Rd, Kingston 6 Jamaica'),
    (
        'Sinatra',
    ...
    ('Fitzgerald', '1217 Kearny St, Berkeley CA 94706'),
    (
        'Holiday',
    ...
    ('Warhol', '117 Sandusky St, Pittsburgh PA 15212'),
    (
        'Dali',
    ...
    ('Banksy', 'Stokes Croft, Bristol BS2 8QR UK'),
    (
        'Hemingway',
        '907 Whitehead St, Key West FL 33040'
    ),
    ('Tolkien', '20 Northmoor Rd, Oxford OX2 6UR UK'),
    (
        'Rowling',
    ...
    ('Dickens', '48 Doughty St, London WC1N 2LX UK'),
    ('Twain', '351 Farmington Ave, Hartford CT 06105'),
    ('Poe', '203 N Amity St, Baltimore MD 21223'),
    ('Wilde', '34 Tite St, Chelsea, London SW3 4JA UK'),
    (
        'Orwell',
